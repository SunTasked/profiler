...
usr_request = args[1]
available_requests = ["train", "classify", "optimize", "dummy-compare"]
...
if usr_request == "dummy-compare":
    print("--------------------------")
    print("Starting dummy comparison.")
    print("--------------------------")
    print()
...
# [Contextual] Train a specified classifier
    ...
    trainer_opt = {"input-dir"            : options.input_dir,
